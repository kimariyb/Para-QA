def re_title_prompt() -> str:
    r"""
    Generate markdown title restructuring prompt for English content.
    
    Returns a structured prompt with formatting rules for reorganizing
    markdown titles based on prefix patterns and semantic hierarchy.
    """
    return """
